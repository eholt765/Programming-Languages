...
main = do
 ...
 print "Result"
 printMaze (onePlayerOneMove maze (head moves))
...
checkForChoice maze (newx,newy) move player
 ...
 where nextMove = getAdjacent (newx,newy)
       ...
       checkLAndD = (((lSpot == '-') || ((lSpot == player))) && ((dSpot == '-') || (dSpot == '-')))
       checkRAndD = (((rSpot == '-') || ((rSpot == player))) && ((dSpot == '-') || (dSpot == '-')))
       checkLAndU = (((lSpot == '-') || ((lSpot == player))) && ((uSpot == '-') || (uSpot == '-')))
       checkRAndU = (((rSpot == '-') || ((rSpot == player))) && ((dSpot == '-') || (dSpot == '-')))
